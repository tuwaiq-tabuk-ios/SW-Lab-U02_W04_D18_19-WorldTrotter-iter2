...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
       ...
       // gradient.colors = [UIColor.white.cgColor, //UIColor.green.cgColor,UIColor.yellow.cgColor,UIColor.red.cgColor, //UIColor.systemPink.cgColor,UIColor.systemIndigo.cgColor,UIColor.gray.cgColor]
